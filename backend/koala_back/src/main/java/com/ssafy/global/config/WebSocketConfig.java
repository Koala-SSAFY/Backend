...
public class WebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	public void configureMessageBroker(MessageBrokerRegistry config) {
		...
		config.enableSimpleBroker("/ws/lecture-sub"); // 메시지 구독 요청
		config.setApplicationDestinationPrefixes("/ws/lecture-chat"); // 메세지를 발행하는 요청
	}
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		// *로 일단 전체 설정해놨음
		registry.addEndpoint("/ws/lecture-chat/connections").setAllowedOriginPatterns("*");
	}
